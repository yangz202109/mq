...
/*Topic模型 所有key都不匹配的消费者Q3案例*/
public class ConsumerQ3 {

    private static final String EXCHANGE_NAME = "TopicExchange";          //交换机名称
    private static final String RABBIT_KEY = "nothink.#";
